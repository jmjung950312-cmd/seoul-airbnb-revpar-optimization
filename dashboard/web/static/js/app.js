        ...
        return `
            <div class="bucket-item bg-white rounded-lg shadow-md p-4 flex items-center gap-3 hover:shadow-lg transition-shadow">
                ...
                <div class="flex gap-2 flex-shrink-0">
                    <button
                        class="btn-edit px-3 py-1.5 bg-blue-50 text-blue-600 text-sm font-medium hover:bg-blue-100 transition-colors"
                        onclick="app.openEditModal('${item.id}', '${this.escapeHtml(item.title).replace(/'/g, "\\'")}')"
                    >
                        수정
                    </button>
                    <button
                        class="btn-delete px-3 py-1.5 bg-red-50 text-red-500 text-sm font-medium hover:bg-red-100 transition-colors"
